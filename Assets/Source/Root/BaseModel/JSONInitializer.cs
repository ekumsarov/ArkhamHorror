...
namespace EVI
{
    public abstract class JSONInitializer<TClass> : IJsonInitializer<TClass>
    {
        ...
        protected void Init(in JSONInitializer<TClass> value, JSONNode node)
        {
            value.SerializeJson(node);
            value.InitializeBase();
        }

        protected void Init(in JSONInitializer<TClass> value, JSONNode node, params object[] args)
        {
            value.SerializeJson(node);
